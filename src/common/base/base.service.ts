...
export abstract class BaseService<Entity extends BaseEntity> {
  ...
  async getAll(where?: FindOptionsWhere<Entity> | FindOptionsWhere<Entity>[], ...relations: string[]): Promise<Entity[]> {
  ...
  async getOne(where?: FindOptionsWhere<Entity> | FindOptionsWhere<Entity>[], ...relations: string[]): Promise<Entity | null> {
    return this.repo.findOne({ where, relations });
  }

  async getOneById(id: string | number, ...relations: string[]): Promise<Entity | null> {
    //@ts-ignore
    return this.repo.findOne({ where: { id }, relations });
  }

  async getOneOrFail(where?: FindOptionsWhere<Entity> | FindOptionsWhere<Entity>[]): Promise<Entity> {
  ...
  async getOneByIdOrFail(id: string | number, ...relations: string[]): Promise<Entity> {
    //@ts-ignore
  ...
  async updateBy(where: FindOptionsWhere<Entity> | FindOptionsWhere<Entity>[], data: QueryDeepPartialEntity<Entity>) {
